            ...
            <ul class="space-y-1 text-base">
                ...
                <!-- <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Referensi</span>
                ...
                <li>
                    <a href="#"
                        ...
                        <span
                            class="ms-4 inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800">
                            4
                        </span>
                    </a>
                </li>
            ...
            <ul class="pt-5 mt-5 space-y-1 border-t border-gray-200 dark:border-gray-700 text-base">
                ...
                <li>
                    <a :href="route('pulse')" target="_blank"
                        class="flex items-center p-2 font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        <svg class="flex-shrink-0 w-6 h-6" viewBox="0 0 33 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <li>
                    <a :href="route('horizon.index')" target="_blank"
                        class="flex items-center p-2 font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        <svg class="flex-shrink-0 w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                            <path
