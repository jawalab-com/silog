...
<template>
    <nav
        class="bg-white border-b border-gray-200 px-4 py-1.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <div v-if="$page.props.jetstream.hasTeamFeatures" id="teamDropdownNavbar"
                    ...
                    <ul v-if="$page.props.auth.user.all_teams.length > 1"
                ...
                <form action="#" method="GET" class="hidden md:block md:pl-2">
                    ...
                    <div class="relative md:w-64 md:w-96">
                        ...
                        <input type="text" name="email" id="topbar-search"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 py-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Search" />
                    </div>
                </form>
            </div>
            <div class="flex items-center lg:order-2">
                ...
                <!-- Settings Dropdown -->
                <button type="button" v-if="$page.props.jetstream.managesProfilePhotos"
                    class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 transition"
                    ...
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            ...
                            <form @submit.prevent="logout">
                                <button type="submit"
                                    class="w-full block py-2 px-4 text-sm text-left hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white rounded-bl-lg rounded-br-lg">
                                    Sign out
                                </button>
                            </form>
                        </li>
