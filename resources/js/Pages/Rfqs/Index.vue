...
const data = props.rfqs.map((item) => ({
    ...
    verified:
        `Kep. Divisi Logistik: ${
            item.verified_1 === 1 ? "✔️" : item.verified_1 === 0 ? "❌" : "-"
        }<br/>` +
        `Admin Gudang: ${
            item.verified_2 === 1 ? "✔️" : item.verified_2 === 0 ? "❌" : "-"
        }<br/>` +
        `Purchasing: ${
            item.verified_3 === 1 ? "✔️" : item.verified_3 === 0 ? "❌" : "-"
        }<br/>` +
        `Pimpinan: ${
            item.verified_4 === 1 ? "✔️" : item.verified_4 === 0 ? "❌" : "-"
        }`,
...
<template>
    <AppLayout :title="title">
        ...
        <div
            class="flex flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4"
            ...
            <template v-slot:actionColumn="{ item, columns, index }">
                <fwb-button-group>
                    <Button
                        ...
                        color="yellow"
                        class="p-0 py-1"
                        :href="route('rfqs.edit', { id: item.id })"
                    >
                    ...
                    <Button
                        color="green"
                        class="p-0 py-1"
                        :href="route('rfqs.show', { id: item.id })"
                    >
