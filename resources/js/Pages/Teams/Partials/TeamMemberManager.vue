            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <TextInput id="name" v-model="addTeamMemberForm.name" type="text" class="mt-1 block w-full" />
                        <InputError :message="addTeamMemberForm.errors.name" class="mt-2" />
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <Select id="division" v-model="addTeamMemberForm.division" class="mt-1 block w-full">
                        ...
                        <InputError :message="addTeamMemberForm.errors.division" class="mt-2" />
                    </div>
                </template>
                        ...
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4 dark:text-white">
                                    {{ user.name }}<br>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ user.division }}</p>
                                </div>
                            </div>
